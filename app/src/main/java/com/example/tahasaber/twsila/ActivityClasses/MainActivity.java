...
import com.example.tahasaber.twsila.FragmentClasses.NotificationFragment;
...
public class MainActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //headerName = (TextView) findViewById(R.id.username_header);
        //headerEmail = (TextView) findViewById(R.id.email_header);

       // headerName.setText(FirebaseAuth.getInstance().getCurrentUser().getDisplayName());
        //headerEmail.setText(FirebaseAuth.getInstance().getCurrentUser().getEmail());
    ...
    public void notifications(View view) {
        ...
        ft.replace(R.id.main_frahgment_container, new NotificationFragment());
