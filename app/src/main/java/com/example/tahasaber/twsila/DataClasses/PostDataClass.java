...
public class PostDataClass {
    ...
    public PostDataClass(String post_body, int acceptance, int acceptedNum, String category, int profile_picture, String post_date, boolean isopend, int category_icon, String user_id, String post_puplisher) {
