    ...
    public void onBindViewHolder(ShareRequestViewHolder holder, final int position) {
        ...
        holder.acceptButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                srh.getNumOfAccepted(postId);
                NotificationDataClass notification = new NotificationDataClass(mUser.getDisplayName(), postBody, "Accepted your join request");
        ...
        holder.rejectButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                FirebaseHandler srh = new FirebaseHandler();
                srh.deleteRequest(postId, requesterId);
                NotificationDataClass notification = new NotificationDataClass(postBody, mUser.getDisplayName(), "Rejected your join request");
                srh.Write_share_request_notification(requesterId, notification);
